...
void GaussianReferenceCheck::beautify(std::shared_ptr<MonitorObject> mo, Quality checkResult)
{
    ...
    float fractionGood = mTotalChannelsAnalyzed > 0 ? 
                        static_cast<float>(mChannelsWithinReference) / mTotalChannelsAnalyzed : 0.0;
    float fractionOverlap = mTotalChannelsAnalyzed > 0 ? 
                           static_cast<float>(mChannelsWithErrorBarOverlap) / mTotalChannelsAnalyzed : 0.0;
